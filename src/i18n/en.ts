...
export const en = {
  ...
  scan: {
    ...
    change: 'Change',
    manualIntro: 'If the QR cannot be read, enter the settings used for printing. The fps and project ID are in every page header; the total frame count is the last frame number in the header of the last page. Grid is how the frames are laid out on a page; width and height are the pixel size of the original video.',
  ...
  animate: {
    ...
    exportMp4: 'Save MP4',
    exportGif: 'Save GIF',
    gifSize: (w: number) => `· ${w}px`,
    exportSize: 'Size',
    sourceSize: 'Original',
    sizeLabel: (short: number) => `${short}p`,
    mp4Quality: 'MP4 quality',
    quality: { high: 'High', standard: 'Standard', light: 'Small file' } as Record<'high' | 'standard' | 'light', string>,
    qualityNote: (mbps: string) => `${mbps} Mbps`,
    gifWidth: 'GIF width',
